...
function init() {
    ...
    var materialArray = [];
    let texture_ft = new THREE.TextureLoader(loadingManager).load('img/skybox/dust_ft.jpg');
    let texture_bk = new THREE.TextureLoader(loadingManager).load('img/skybox/dust_bk.jpg');
    let texture_up = new THREE.TextureLoader(loadingManager).load('img/skybox/dust_up.jpg');
    let texture_dn = new THREE.TextureLoader(loadingManager).load('img/skybox/dust_dn.jpg');
    let texture_rt = new THREE.TextureLoader(loadingManager).load('img/skybox/dust_rt.jpg');
    let texture_lf = new THREE.TextureLoader(loadingManager).load('img/skybox/dust_lf.jpg');
    ...
    let skyboxGeo = new THREE.BoxGeometry(250, 250, 250);
